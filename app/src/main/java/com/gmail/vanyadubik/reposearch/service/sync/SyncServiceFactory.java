...
import static com.gmail.vanyadubik.reposearch.common.Consts.CONNECT_SERVER_URL;
import static com.gmail.vanyadubik.reposearch.common.Consts.CONNECT_TIMEOUT_SECONDS_RETROFIT;
...
public class SyncServiceFactory {
    ...
    public static <S> S createService(Class<S> serviceClass, Context context) {
        ...
        Retrofit retrofit;
//        try {
//            retrofit = getBuilder(CONNECT_SERVER_URL).client(client).build();
